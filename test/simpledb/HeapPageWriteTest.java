...
public class HeapPageWriteTest extends SimpleDbTestBase {
	...
	//		{	
//				System.out.println("Before Write Test :: tuples :: " + tuples + 
//						" First Element :: " + tuples.indexOf(1) + " Last Element :: "
//						+ tuples.indexOf(tuples.size() -1));
//	//		}
			if (tuples.size() > 0)
				page.deleteTuple(tuples.removeLast());
				System.out.println("Last Tuple :: " + tuples.removeLast());
			
	//		for(int i=0 ; i < tuples.size();i++)
		//	{	
//				System.out.println("After Write Test :: tuples :: " + tuples + 
//						" First Element :: " + tuples.indexOf(0) + " Last Element :: "
//						+ tuples.indexOf(tuples.size() -1));
		//	}
			//System.out.println("Tuples Size :: " + tuples.size() + " Count :: " + tupleCount(page));

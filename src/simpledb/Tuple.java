...
public class Tuple {
	...
	public String toString() {
		// BufTupleString is a StringBuffer with which we can modify the String.
		StringBuffer BufTupleString = new StringBuffer();
		
		// Loop to append the Field values
		for (int i=0; i< fields.length ; i++)
		{
			BufTupleString.append(fields[i]);
			...
			{
				BufTupleString.append(", ");
			}
		}
		// Converting the StringBuffer to String by toString() Method.
		String TupleString = BufTupleString.toString();
		System.out.println("TupleString is :: " + TupleString);

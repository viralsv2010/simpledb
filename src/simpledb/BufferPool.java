...
public class BufferPool {
	...
	public Page getPage(TransactionId tid, PageId pid, Permissions perm)
			throws TransactionAbortedException, DbException {
				// Checking whether the pages hashtable contains the pid in its key
				// pairs. If contains then simply return the page associated with 
				// that pid. Else, read the page from DBFile.
				...
				else
				{
					...
					Page bufferpool_page = dbFile.readPage(pid);
